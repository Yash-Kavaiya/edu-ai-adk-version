...
export default function InterdisciplinaryPage() {
  ...
  const handleAnswerSelect = (option: string) => {
    if (selectedOption) return; // Já respondida
  ...
  const generateNewQuestion = () => {
    ...
    // Usar os mesmos parâmetros para gerar nova questão
          ...
          <div className="space-y-4 flex flex-col items-center">
            <div className="space-y-2">
              <h2 className="text-2xl font-semibold text-white">
                Gerando questão interdisciplinar...
              </h2>
              <p className="text-white/70">
                Conectando {form.area1} e {form.area2} em uma questão única
              </p>
            </div>
            <Link href="/interdisciplinary-questions">
              <Button
                variant="outline"
          ...
          >
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-white/70 text-lg">
                Conecte diferentes áreas do conhecimento em questões
                desafiadoras
              </p>
            </div>
            ...
            <Card className="glass-card border-white/10">
              <CardHeader>
                <CardTitle className="text-white flex items-center gap-2">
                  ...
                  Selecione as Áreas do Conhecimento
                </CardTitle>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleFormSubmit} className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      ...
                      Gerar Questão Interdisciplinar
                      <ArrowRight className="w-5 h-5 transition-transform duration-200 group-hover:translate-x-1" />
                    </Button>

                    {form.area1 === form.area2 && (
                      <p className="text-yellow-400 text-sm text-center">
                        Selecione duas áreas diferentes para criar uma questão
                        interdisciplinar
                      </p>
                    )}
            ...
            <Card className="glass-card border-white/10">
              ...
              <CardContent className="space-y-4">
                {Object.entries(question.alternativas).map(([letra, texto]) => {
                  ...
                  const isCorrectAnswer = question.resposta_correta === letra;
